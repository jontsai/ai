...
LANGUAGES = [
    ...
    ("CosyVoice - Chinese", "cmn", [
        V("cosyvoice_default_zh", "default female", name="小月", gender="Female", lang_code="cmn",
    ...
    ("CosyVoice - English", "en-us", [
        V("cosyvoice_default_en", "default female", name="Xiaoyue", gender="Female", lang_code="en-us",
          ref_audio="cosyvoice/asset/zero_shot_prompt.wav"),
